<template>
  <a-dropdown trigger="contextMenu" :popup-max-height="false" @select="actionSelect">
    <span
      ...
      :data-fullPath="itemData.fullPath"
      @click="goto(itemData)"
    >
      <span class="tag-link">
        {{ itemData.title }}
      ...
      <span
        ...
        v-if="itemData.name !== DEFAULT_TAB_ROUTE_NAME"
...
import { DEFAULT_TAB_ROUTE_NAME, REDIRECT_ROUTE_NAME } from '@/router/constants'
...
const actionSelect = async (value: any) => {
  ...
  if (value === Eaction.current) {
    ...
    router.push({ name: DEFAULT_TAB_ROUTE_NAME })
  }
}
</script>
